...
class SimpleHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    calling the .guess_type() method. And can receivge file uploaded
    by client.
    ...
    def do_AUTHHEAD(self):
        ...
        self.send_header("WWW-Authenticate", 'Basic realm="BOHICA LABS"')
    ...
    def list_directory(self, path):
        ...
        for name in list:
            ...
            f.write((
                            ...
                            % (dirimage, urllib.parse.quote(linkname), html.escape(displayname), fsize,
                               created_date)).encode(enc))
        f.write(b"</table><hr>\n</body>\n</html>\n")
        length = f.tell()
        f.seek(0)
        self.send_response(200)
